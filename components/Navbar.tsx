...
export default function Navbar({ children }: Props) {
        ...
        if (mutation.type === "childList") {
          ...
          mutation.addedNodes.forEach((node) => {
            ...
            if (node instanceof HTMLDivElement) {
              node.querySelector(".message-content-div")?.scrollTo({
                top: node.querySelector(".message-content-div")?.scrollHeight,
                behavior: "instant",
              });
            }
  ...
  return (
    <div className="flex flex-col h-screen overflow-scroll">
      <nav className="flex-shrink-0 sticky top-0 left-0 bg-white border-b border-gray-100 shadow-sm z-50">
      ...
      <main className="flex-1 min-h-0 overflow-scroll">{children}</main>
